...
String::String() : size_( 0 ), capacity_( CalcCapacity( 0 ) ), data_( CalcCapacity( 0 ) ) {
	data_[ 0 ] = '\0';
}

String::String( size_t size ) : size_( 0 ), capacity_( CalcCapacity( size ) ), data_( CalcCapacity( size ) ) {
	data_[ 0 ] = '\0';
}

String::String( const String& otherString )
	: size_( otherString.size_ ), capacity_( otherString.capacity_ ), data_( otherString.capacity_ ) {
...
String::String( String&& otherString ) noexcept
	: data_( std::move( otherString.data_ )), size_( std::move( otherString.size_ ) ),
